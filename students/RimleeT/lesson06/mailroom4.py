...
def do_thankyou():
	...
	find_donor(donor_name,donation_amount)
...
def find_donor(donor_name,donation_amount):
...
def gen_stats(donor, donations):
    ...
    return("{0:18}      ${1:13}{2:15}     ${3:12}".format(donor, total_donation, num_donation, avg_donation))
