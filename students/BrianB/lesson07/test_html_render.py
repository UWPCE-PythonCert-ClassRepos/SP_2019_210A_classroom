...
# import * is often bad form, but makes it
# easier to test everything in a module.
...
def test_anchor1():
    ...
    assert file_contents.startswith('<a ref="http://google.com">')
...
def test_doctype():
    """
    Tests that the html class properly adds a doctype
    only once to the start of the file
    """
...
def test_element_indent1():
    ...
    assert lines[1].startswith(Element.indent + "this")
    assert lines[2] == "</html>"
    assert file_contents.endswith("</html>")
