...
# Utility to make pretty printing easier
...
def get_donor_db():
    return {'william gates': ("William Gates III", [653772.32, 12.17]),
...
def return_to_menu():  # Return True to trigger exit out of sub-loop
    return True


def quit_program():  # Function for quitting thr progra
    print("Program Quit!!")
    sys.exit(0)
