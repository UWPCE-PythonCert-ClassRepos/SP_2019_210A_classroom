...
def test_head():
    e = Head("this is some text in head")
    e.append("and this is some more text in head")

    file_contents = render_result(e).strip()

    assert("this is some text in head") in file_contents
    assert("and this is some more text in head") in file_contents
...
def test_onelinetag():
    e = Title("this is some text in title")

    file_contents = render_result(e).strip()

    assert ("this is some text in title") in file_contents
    print(file_contents)
